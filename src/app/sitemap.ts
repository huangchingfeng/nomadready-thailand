...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${baseUrl}/pattaya-workation`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    {
      url: `${baseUrl}/pattaya-72-hour-workation-checklist`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.86,
    },
    {
      url: `${baseUrl}/pattaya-digital-nomad-guide`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    {
      url: `${baseUrl}/pattaya-vs-phuket-digital-nomad`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.82,
    },
    {
      url: `${baseUrl}/jomtien-vs-pratumnak`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/thailand-beach-workation`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.82,
    },
    {
      url: `${baseUrl}/pattaya-cost-of-living-digital-nomad`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/pattaya-without-nightlife-trap`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.78,
    },
    {
      url: `${baseUrl}/best-thailand-cities-digital-nomads`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.83,
    },
    {
      url: `${baseUrl}/thailand-workation-checklist`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.84,
    },
